...
Fixpoint translate_predicate (bindings:Γᵥ) (t_inf : type_inf) (e: ψ) (p: predicate) : state  := match p with
    ...
    | Not p => 
        ...
        mkSTR gmp_statement (mkTR gmp_statement code p_tr.(tr).(tenv gmp_statement) nil) decl (C_Id c C_Int)
    ...
    | Disj p1 p2 => 
        ...
        in
        mkSTR gmp_statement (mkTR gmp_statement code tr_p2.(tr).(tenv gmp_statement) nil) decl  (C_Id c C_Int)
    ...
    | P_BinOp t1 fsl_op t2 =>
        ...
        ret (mkSTR gmp_statement (mkTR gmp_statement code tr_t2.(tr).(tenv gmp_statement) nil) decl  (C_Id c C_Int))
...
with translate_term (bindings : Γᵥ) (t_inf : type_inf) (e: ψ) (t : fsl_term) : state := match t with
    ...
    | T_BinOp t1 _op t2 => 
        ...
        ret (mkSTR gmp_statement (mkTR gmp_statement code t2_tr.(tr).(tenv gmp_statement) nil) decl (C_Id c C_Int))
    ...
    | T_Cond p t1 t2 => 
        ...
        mkSTR gmp_statement (mkTR gmp_statement code t2_tr.(tr).(tenv gmp_statement) nil) decl  (C_Id c C_Int)
    end
